...
import com.note.remiads.dialog.DialogLoadAds;
import com.note.remiads.itf.ShowAdsListen;
import com.note.remiads.utils.RmSave;
import com.note.remiads.utils.RmUtils;
...
public class FullManager {
    ...
    public void loadAds(Context c) {
        ...
        if (isGoogleFist) {
            InterstitialAd.load(c, c.getString(R.string.ads_full), new AdRequest.Builder().build(), new InterstitialAdLoadCallback() {
                @Override
