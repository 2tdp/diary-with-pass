package com.note.mydiary.diarywithlock.journalwithlock.customview.CustomCalendar.utils;
...
public class CalendarUtils {
    ...
    public static boolean isToday(Calendar calendar) {
        return isSameDay(calendar, Calendar.getInstance(Constant.LOCALE_DEFAULT));
    }
    ...
    public static int getTotalWeeks(Date date) {
        Calendar cal = Calendar.getInstance(Constant.LOCALE_DEFAULT);
        cal.setTime(date);
