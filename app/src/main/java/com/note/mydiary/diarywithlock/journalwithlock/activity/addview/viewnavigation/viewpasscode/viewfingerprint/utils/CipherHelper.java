...
public class CipherHelper {
    ...
    public FingerprintManager.CryptoObject getEncryptionCryptoObject() {
        ...
        createCipher();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (initEncryptionCipher()) return new FingerprintManager.CryptoObject(cipher);
            else return null;
        } else return null;
    }
    ...
    public FingerprintManager.CryptoObject getDecryptionCryptoObject(byte[] ivBytes) {
        ...
        createCipher();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (initDecryptionCipher(ivBytes)) return new FingerprintManager.CryptoObject(cipher);
            else return null;
        } else return null;
    }
}
