...
public class FileDownloadService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (bundle == null || !bundle.containsKey(DOWNLOADER_RECEIVER) || !bundle.containsKey(DOWNLOAD_DETAILS))
            return;
    ...
    private void unzip(String zipFilePath, String unzipAtLocation) throws Exception {
        ...
        try {
            ...
            Log.e("Unzip zip", "Unzip exception" + e.getMessage(), e);
        }
    }
    ...
    private void unzipEntry(ZipFile zipfile, ZipEntry entry, String outputDir) throws IOException {
        ...
        if (!canonicalPath.startsWith(outputDir)) throw new SecurityException();
    ...
    public static class FileDownloader extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (onDownloadStatusListener == null) return;
